...
namespace Topic_2___Scaling_Using_Rectangles
{
    public class Game1 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.Draw(rectTexture, new Rectangle(50, 150, 25, 75), Color.Green);
            _spriteBatch.DrawString(textFont, "Aldworth", new Vector2(250, 250), Color.DarkBlue);
